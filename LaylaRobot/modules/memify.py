...
from LaylaRobot import LOGGER, TEMP_DOWNLOAD_DIRECTORY, telethn as bot
...
async def drawText(image_path, text):
    ...
    if os.name == "nt":
        ...
        fnt = "./LaylaRobot/resources/Lucky-Boss.ttf"
...
__help__ = """
• /mmf - Provide Some Text To Draw! And Reply To Image/Stickers
EXAMPLE: /mmf text
"""
